  ...
  return (
    <div className="section border-b-[1px] flex justify-between px-6 py-[0.675rem] md:py-2.5 text-black text-sm w-full">
      <div className="left flex">
        ...
        <div className="hidden md:flex items-center bg-gray-light rounded-2xl w-24 ml-6 px-3 py-1">
          <img src={Search} alt="search-icon" className="w-6 text-primary" />
          <input
            type="text"
            className="focus:outline-none bg-gray-light px-4 rounded-2xl h-full"
            placeholder="Search"
          />
        </div>
      </div>
